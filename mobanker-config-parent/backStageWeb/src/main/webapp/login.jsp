...
<head>
	...
	<link href="${ctx}/static/mobanker/img/favicon.ico" rel="icon" type="image/x-icon" />
	<link href="${ctx}/static/mobanker/img/favicon.ico" rel="shortcut icon" />
				...
				<div class="login-container">
					<div class="center">
						<h1>
							...
							<img src="${ctx}/static/mobanker/img/logo.ico">
