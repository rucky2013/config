...
import com.mobanker.config.service.constants.ZkConstants;
import com.mobanker.config.service.constants.enums.ModuleStatus;
import com.mobanker.config.service.dto.StaticSystemVariableDto;
import com.mobanker.config.service.entity.ActiveSystemVariable;
...
import com.mobanker.config.service.manager.ZkDataPushManager;
import com.mobanker.config.service.service.SystemModuleService;
import com.mobanker.config.service.utils.ValidateUtil;
import com.mobanker.config.service.zookeeperScheme.factory.ZookeeperFactory;
import com.mobanker.config.service.zookeeperScheme.template.TreeCacheTemplate;
 ...
 * com.mobanker.config.bsw.manager.impl Description : Author : cailinfeng Date :
 * 2016/1/29
 */
@Service
