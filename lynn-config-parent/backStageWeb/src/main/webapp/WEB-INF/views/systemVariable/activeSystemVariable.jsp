    ...
    <div class="col-xs-12">
        ...
        <div class="table-header">
            ...
            <div style="float:right;padding-right: 10px;height: 38px;font-size: 14px;">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
               <!--   <a href="javaScript:void(0)" target="_top" id="export" onclick="exportZK()"><button class="btn btn-xs btn-yellow" >
...
<div class="modal fade" id="addSys" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="table-header">
                <font id="myModalLabel">添加动态系统变量</font>
...
<script type="text/javascript">
        ...
        function initData(url){
            ...
            if(url == null || url == ''){
                url = '${ctx}/systemVariable/&&&&/active';
                InitStatus();
                InitSystem();
            }else{
                url = '${ctx}/systemVariable/'+$("#aSystemName").val()+'&'+$("#aModuleName").val()+'&'+
                $("#aNid").val()+'&'+$("#aName").val()+'&'+$("#aStatus").val()+'/active';
            }
                               ...
                               render : function(data, type, row){
                                   ...
                                   if(data.status=='NORMAL'){
	                                   ...
	                                   redirectBtn +="<a href='#' class='green tooltip-success' data-rel='tooltip' title='修改' " +
	                                           "onclick=editSys('"+escape(data.id)+"','"+escape(data.systemName)+"','"+escape(data.moduleName)+"','"+escape(data.status)+"','"+escape(data.nid)+"','"+escape(data.name)+"','"+escape(data.value) +"','"+escape(data.remark)+"');><i class='icon-edit bigger-120' > </i></a>&nbsp;&nbsp;&nbsp;&nbsp;";
...
//         }
        function pushDataToZk(src){
            ...
            var url = "${ctx}/zookeeper/pushDynamicToZk";
            var dataJson = {
